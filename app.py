...
def check_location(n_clicks, plate, lat, lon):
    ...
    pl_result = check_vehicle_mot(plate)
    if pl_result["valid_mot"]:
        plate_text = "Vehicle has a valid MOT."
    else:  
    ...
    return f"{plate_text} The coordinates you gave is {geofence_text}."
